...
name: nda-triaging
description: >
  Voorlopige beoordeling van inkomende NDA's (geheimhoudingsovereenkomsten) naar
  Nederlands recht en classificatie als GROEN (standaard), GEEL (vereist beoordeling)
  of ROOD (significante problemen). Gebruik wanneer een nieuwe NDA binnenkomt vanuit
  de verkoop- of business development-afdeling, bij het beoordelen van het risiconiveau
  van een NDA, of bij de beslissing of een NDA een volledige juridische beoordeling
  vereist in de context van Nederlands recht.
---

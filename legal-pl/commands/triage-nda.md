---
description: Rapidly triage an incoming NDA — classify as standard approval, counsel review, or full legal review (Polish law context with IURA MCP)
...
### Krok 2: Załadowanie playbooka NDA

Poszukaj kryteriów przesiewowych NDA w ustawieniach lokalnych (np. `legal.local.md`).
...
### Krok 3: Analiza prawna z IURA MCP

Przed przystąpieniem do przesiewu, wykorzystaj IURA MCP do zebrania kontekstu prawnego:

1. **Przepisy o tajemnicy przedsiębiorstwa** (Search_DU): Wyszukaj aktualne brzmienie art. 11 ustawy o zwalczaniu nieuczciwej konkurencji (UZNK) oraz powiązane przepisy KC dotyczące zobowiązań umownych z użyciem parametru `in_force_as_of` z dzisiejszą datą.

2. **Orzecznictwo dotyczące NDA** (Search_SN, Search_SP): Wyszukaj precedensy dotyczące:
   - Egzekwowania umów o zachowaniu poufności
   - Definicji tajemnicy przedsiębiorstwa w rozumieniu art. 11 UZNK
   - Kar umownych w umowach NDA
   - Zakresu i skuteczności klauzul poufności

3. **Klauzule abuzywne** (Search_SN): Jeśli NDA jest narzucone przez silniejszą stronę, sprawdź orzecznictwo dotyczące klauzul abuzywnych (art. 385¹ KC) w kontekście umów poufności.

Wyniki wyszukiwania wykorzystaj w ocenie poszczególnych kryteriów — powołuj się na sygnatury orzeczeń i numery artykułów.

### Krok 4: Szybki przesiew
...
### Krok 6: Generowanie raportu triażu
...
[Podsumowanie znalezionych przepisów i orzeczeń dotyczących tajemnicy przedsiębiorstwa i NDA]
...
**Podstawa prawna**: [przepis KC/UZNK lub sygnatura orzeczenia]
...
- Przy powoływaniu się na tajemnicę przedsiębiorstwa, stosuj aktualną definicję z art. 11 UZNK (weryfikowaną przez IURA MCP)
